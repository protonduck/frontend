...
const validationSchema = object().shape({
  email: string().required('views.login.form.email.error.required').email('views.login.form.email.error.required'),
  password: string().required('views.login.form.password.error.required').min(6),
});
  ...
  <div class="box">
    ...
    <form @submit="onSubmit" novalidate>
      <e-input
        ...
        type="email"
        autocomplete="email"
        label="views.login.form.email.label"
      ...
      <e-input
        ...
        id="password"
        type="password"
        label="views.login.form.password.label"
